...
The implementation also includes large scale systems for single and double kinks.
<!-- LP,LF: Prior sentence is unclear: Does it include data files are functions to do large scale systems? What is special about large scale systems? -->
...
# Code philosophy and structure
 ...
 It is built around the Atomic Simulation Environment (ASE) [@Larsen2017] that offers great flexibility and interoperability by providing a Python interface to tens of simulation codes implementing different physical models.

# Other software addressing similar needs

# Acknowledgements

We thank Alexander Held for initial contributions to the `pressurecoupling.py` module and Michael Walter for initial contributions to the `opls.py` module. `matscipy` was partially funded by the Deutsche Forschungsgemeinschaft (projects 258153560, 390951807 and 461911253), the European Research Council (ERC StG 757343) and by the Engineering and Physical Sciences Research Council (grants EP/P002188/1, EP/R012474/1 and EP/R043612/1).

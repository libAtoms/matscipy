...
def target_function(x, d=2.0, constraints=None):
    """Target function. Penalizes too dense packing for coordinates ||xi-xj|| < d.
...
def box_constraint(x, box=np.array([[0.,0.,0],[1.0,1.0,1.0]]), d=0.):
    ...
    x: np.ndarray((sample_size,3))
      coordinates
    box: np.ndarray((2,3)), optional (default: [[0.,0.,0.],[1.,1.,1.]])

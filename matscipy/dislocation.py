...
def _validate_disloc_inputs(a, symbol="w", axes=None, crystalstructure="fcc", pbc=[True, True, True]):
    ''''
    Validate & transform args of dislocation class __init__ methods
    ...
    try:
        ...
        if type(e) == KeyError:
            ...
            raise TypeError(f"crystalstructure argument {crystalstructure} is not a string")
